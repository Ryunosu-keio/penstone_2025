...
diff_list = ["avg_diff", "max_diff", "avg_diff_low_freq", "avg_diff_high_freq"]

         
# feature_list = ["entropy_gray", "entropy_rgb"]

df = pd.read_excel("../data/final_recent_dark/final_recent_dark_add_entropy_fft_button_dropna.xlsx")
# df = df[df["isred"] == "red"]
...
for num in num_list:
    ...
    print(num)
    plot_cor_for_each_feature(df_num, y_feature="diopter", feature_list=button_list)




# plot_cor_for_each_feature(df, y_feature="diopter", feature_list=button_list)
