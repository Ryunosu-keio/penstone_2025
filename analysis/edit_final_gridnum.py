...
# df_par_grid のCSVファイルのリストを取得
df_par_grid_list = glob.glob("../histogram/red_grids_dark/*.csv")
...
print(image_names)
# 一致する行を "red" に更新
df_dark.loc[df_dark['image_name'].isin(image_names), 'is_red'] = "red"
# 一致しない行を"blue"に更新
df_dark.loc[~df_dark['image_name'].isin(image_names), 'is_red'] = "blue"
